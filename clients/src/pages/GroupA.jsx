    ...
    <>
      ...
      <div className="text-center">
        ...
        <div className="flex justify-center">
          <div className="max-w-screen-md">
            <h2 className="text-center  mt-10 md:mt-32 font-medium text-xl my-5">
             <span className='text-red-700 text-xl'>Q:</span> What is the Blood<span className="text-red-700 font-bold "> Group A Negative</span>
            </h2>
        ...
        <div className="flex justify-center">
          <div className="max-w-screen-md">
            <h2 className="text-center mt-10 md:mt-32 font-medium text-xl my-5">
            <span className='text-red-700 text-xl'>Q:</span>  What is the Blood<span className="text-red-700 font-bold"> Group A Positive</span>
            </h2>
            <p className="text-center font-medium text-xl">
