      ...
      <div className="text-center">
        <div>
          <h1 className="text-center mx-20 my-10 font-medium text-3xl">
            Welcome to Bank Group O
          </h1>
        </div>
        <div className="flex justify-center">
          <div className="max-w-screen-md">
            <h2 className="text-center  mt-10 md:mt-32 font-medium text-xl my-5">
             <span className='text-red-700 text-xl'>Q:</span> What is the Blood<span className="text-red-700 font-bold "> Group O Negative</span>
            </h2>
        ...
        <div className="flex justify-center">
          <div className="max-w-screen-md">
            <h2 className="text-center mt-10 md:mt-32 font-medium text-xl my-5">
            <span className='text-red-700 text-xl'>Q:</span>  What is the Blood<span className="text-red-700 font-bold"> Group O Positive</span>
            </h2>
            <p className="text-center font-medium text-xl">
